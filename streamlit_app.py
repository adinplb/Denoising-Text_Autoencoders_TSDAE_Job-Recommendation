...
def download_nltk_resources():
    resources_to_download = {
        "stopwords": "corpora/stopwords", # Path for checking stopwords
        "punkt": "tokenizers/punkt",       # Path for checking punkt
        "punkt_tab": "tokenizers/punkt_tab" # Path for checking punkt_tab (though often part of punkt)
    }
